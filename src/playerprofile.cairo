...
use core::array::ArrayTrait;
    ...
    struct Storage {
        ...
        // Puzzle statistics
        player_puzzle_stats: Map<(ContractAddress, u32), PuzzleStats>, // Maps (player, puzzle_id) to stats
        
        // Level unlocking
        levels_count: u32,
        level_unlocks: Map<u32, LevelUnlock>, // Maps level_id to unlock requirements
        player_unlocked_levels: Map<(ContractAddress, u32), bool>, // Maps (player, level_id) to unlock status
        ...
        // Streak tracking
        last_day_timestamp: Map<ContractAddress, u64>, // Maps player to last day timestamp (for streak)
    }
    ...
    impl PlayerProfileImpl of IPlayerProfile<ContractState> {
        ...
        // Level unlocking
        fn unlock_level_with_achievement(ref self: ContractState, level_id: u32, achievement_id: u32) {
            let caller = get_caller_address();
            ...
            if level.prerequisite_level > 0 {
                let prereq_unlocked = self.player_unlocked_levels.read((caller, level.prerequisite_level));
    ...
    impl InternalFunctions of InternalFunctionsTrait {
        ...
        fn _update_streak(ref self: ContractState, player: ContractAddress, current_timestamp: u64) {
